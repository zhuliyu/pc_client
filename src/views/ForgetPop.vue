...
import { apiConfig, fetch, post, _Fetch } from '@/utils/api/Interfaces'
...
export default class ForgetPop extends Vue {
  ...
  identifyingCodeRules (rule:any, value:string, callback:any) {
    if (value === '') {
      ...
      if (value.toLowerCase() !== this.tempCode.toLowerCase()) {
...
<style scoped lang="less" type="text/less">
  @deep: ~'>>>';
  .forget-form .identifyingCode @{deep} .el-input {width: calc(100% - 126px);}
  .forget-form @{deep} .el-input input {height: 40px;}
  .forget-form .forget-form-btn @{deep} .el-button {width: 48%;height: 45px;font-size: 18px;float: left;/*px*/}
  .forget-form .final-step-login @{deep} .el-button {width: 100%;height: 45px;font-size: 18px;float: left;/*px*/}
